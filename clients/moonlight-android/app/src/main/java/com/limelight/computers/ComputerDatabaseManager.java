...
public class ComputerDatabaseManager {
    ...
    private interface AddressFields {
        ...
        String IPv6 = "ipv6";
        String NAT_DDNS_ENABLED = "natDdnsEnabled";
        String NAT_DDNS_URL = "natDdnsUrl";
        String NAT_DDNS_MAPPING = "natDdnsMapping";
    ...
    public boolean updateComputer(ComputerDetails details) {
        ...
        try {
            ...
            addresses.put(AddressFields.NAT_DDNS_ENABLED, details.natDdnsEnabled);
            if (details.natDdnsUrl != null) {
                addresses.put(AddressFields.NAT_DDNS_URL, details.natDdnsUrl);
            }
            if (details.natDdnsMapping != null && details.natDdnsMapping.isValid()) {
                addresses.put(AddressFields.NAT_DDNS_MAPPING, details.natDdnsMapping.toJson());
            }
    ...
    private ComputerDetails getComputerFromCursor(Cursor c) {
        ...
        try {
            ...
            details.natDdnsEnabled = addresses.optBoolean(AddressFields.NAT_DDNS_ENABLED, false);
            details.natDdnsUrl = addresses.optString(AddressFields.NAT_DDNS_URL, null);
            details.natDdnsMapping = NatDdnsMapping.fromJson(
                    addresses.optJSONObject(AddressFields.NAT_DDNS_MAPPING),
                    details.natDdnsUrl);
        } catch (JSONException e) {
            throw new RuntimeException(e);
         }
