...
public class ServerHelper {
    ...
    public static Intent createStartIntent(Activity parent, NvApp app, ComputerDetails computer,
        ...
        if (computer.natDdnsEnabled && computer.natDdnsMapping != null && computer.natDdnsMapping.isValid()) {
            intent.putExtra(Game.EXTRA_NAT_DDNS_URL, computer.natDdnsUrl);
            intent.putExtra(Game.EXTRA_NAT_DDNS_MAPPING, computer.natDdnsMapping.toJsonString());
        }
        try {
