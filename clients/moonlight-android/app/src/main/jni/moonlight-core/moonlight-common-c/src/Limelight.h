...
#define LI_PORT_PROTO_TCP 6
#define LI_PORT_PROTO_UDP 17

typedef struct _LI_PORT_MAPPING {
    int protocol;
    unsigned short originalPort;
    unsigned short mappedPort;
} LI_PORT_MAPPING, *PLI_PORT_MAPPING;
...
typedef struct _SERVER_INFORMATION {
    ...
    // Optional NAT-DDNS port mappings. These map Sunshine's logical ports to
    // the public ports that should be used for actual socket connections.
    const LI_PORT_MAPPING* portMappings;
