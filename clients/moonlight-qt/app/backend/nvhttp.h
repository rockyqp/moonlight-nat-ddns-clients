...
public:
    ...
    explicit NvHTTP(NvAddress address,
                    uint16_t httpsPort,
                    QSslCertificate serverCert,
                    QNetworkAccessManager* nam = nullptr,
                    NatDdnsMapping natDdnsMapping = NatDdnsMapping());
    ...
    void setNatDdnsMapping(NatDdnsMapping natDdnsMapping);
    ...
    QUrl m_BaseUrlHttps;
private:
    uint16_t mapTcpPort(uint16_t port) const;
