...
public class Game extends Activity implements SurfaceHolder.Callback,
    ...
    public static final String EXTRA_NAT_DDNS_URL = "NatDdnsUrl";
    public static final String EXTRA_NAT_DDNS_MAPPING = "NatDdnsMapping";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String natDdnsUrl = Game.this.getIntent().getStringExtra(EXTRA_NAT_DDNS_URL);
        String natDdnsMappingJson = Game.this.getIntent().getStringExtra(EXTRA_NAT_DDNS_MAPPING);
        NatDdnsMapping natDdnsMapping = NatDdnsMapping.empty();
        if (natDdnsMappingJson != null) {
            try {
                natDdnsMapping = NatDdnsMapping.fromJson(natDdnsMappingJson, natDdnsUrl);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        conn = new NvConnection(getApplicationContext(),
                ...
                PlatformBinding.getCryptoProvider(this), serverCert, natDdnsMapping);
