...
class ComputerManager : public QObject
{
    ...
    friend class PendingNatDdnsRefreshTask;
...
public:
    ...
    void refreshNatDdnsHost(NvComputer* computer);
...
signals:
    ...
    void natDdnsRefreshCompleted(NvComputer* computer, QString error);
...
private slots:
    ...
    void handleNatDdnsRefreshCompleted(NvComputer* computer, QString error);
